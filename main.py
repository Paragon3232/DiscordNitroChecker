    ...
    def main(self): 
        ...
        if os.name == "nt":
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator and Checker || Paragon#3232") 
        else: 
            print(f'\33]0;Nitro Generator and Checker || Paragon#3232\a',
                  end='', flush=True) 
...
▓██░   █▒▓█   ▀  ██ ▀█   █ ▒██▀ ██▌▓█   ▀▓  ██▒ ▓▒▓  ██▒ ▓▒▒████▄    
 ...
 """) 
        ...
        self.slowType("Made by: Paragon#3232", .02)
        time.sleep(1) 
   
        self.slowType(
            "\nInput Number Of Nitros You Want To Check: ", .02, newLine=False)
        ...
        for s in c:  
            ...
            if os.name == "nt":  
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid || Paragon#3232")
                print("")
            else:  
                print(
                    f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid || Paragon#3232\a', end='', flush=True)
